...
fetch_mt6833_common_repo() {
	local URL=https://github.com/infinixs5lite/twrp-transsion_device_common-mt6833.git
	local common=device/transsion/mt6833-common
	if [ ! -d $common ]; then
		echo "Cloning $URL ... to $common"
		git clone $URL -b twrp-12.1-U $common
	else
